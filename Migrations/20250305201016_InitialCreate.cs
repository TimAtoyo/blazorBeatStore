    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Genres__0385055E65F0E3E1", x => x.GenreID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CCAC4C93C8E2", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AdminLog__5E5499A80530A125", x => x.LogID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Beats__0FFC755F1C30A496", x => x.BeatID);
                    table.ForeignKey(
                        name: "FK_Beats_Genres",
                        column: x => x.GenreID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__6B0A6BDE1F26E219", x => x.PurchaseID);
                    table.ForeignKey(
                        name: "FK_Purchases_Beats",
                        column: x => x.BeatID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beats_UploadedBy",
                table: "Beats",
                column: "UploadedBy");

            migrationBuilder.CreateIndex(
                name: "UQ__Genres__BBE1C339BD7F8AD6",
                table: "Genres",
                column: "GenreName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__536C85E47903314B",
                table: "Users",
                column: "Username",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D10534B6C89CC6",
                table: "Users",
                column: "Email",
                unique: true);
        }
